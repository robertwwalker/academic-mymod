...
County.Data.2 <- read.csv("~/Downloads/TheGovernmentFinanceDatabase_CountyData/CountyData.csv")
County.Data.2 <- County.Data.2 %>% mutate(region = FIPS_Code_State* 1000 + FIPS_County)
friendly <- inner_join(County.Data.2,county.regions,by="region")
