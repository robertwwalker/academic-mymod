...
I decided it was time to experiment with shiny apps again and so I built one out of this.  [Check it out!][https://rwalkerwu.shinyapps.io/NFL-Scrapr/].  There is one thing that I do not like.  The labels are messed up by overtime games.  I finally managed to fix that, both above and in the Shiny by taking game time remaining and turning the overtime seconds into negatives; that made sense given the flipped scale.
