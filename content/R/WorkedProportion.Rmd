...
0.51 is too close to 0.5 with this size of sample to conclude that the *true* probability isn't 0.5.  

# Directional Claims

Now we only place the $z$ we obtained on the graph.
...
Now let's look at the two directions we could examine.  Is the *true* probability 0.5 or greater, compared to less?  If it is less, we would expect the sample data to be below the claim.  Here, it is not, but the p-value will simply measure all of the probability up to the $z$ we obtained: 0.2.
