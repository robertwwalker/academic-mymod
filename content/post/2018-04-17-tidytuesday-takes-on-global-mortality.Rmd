...
cplot <- ggplot(mydf, aes(name,value)) + geom_bar(stat="identity") + coord_flip() + ylab("Within Country Percent of Total Variation") + xlab("Cause of Mortality") + ggtitle("Within-country variation in the Causes of Death (1990-2016)")
cplot
```
