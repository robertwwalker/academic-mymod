...
library(magrittr)
library(tidytext)
load("~/R/MyNLWeb/data/PresText.RData")
text_df <- data_frame(text=as.character(unlist(Pres.Acts)))
k <- NULL
...
myPA.df <- data.frame(doc=mydoc,line=myline,text=text_df)
...
So what does the President talk about?
