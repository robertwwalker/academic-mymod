...
saveWidget(l, here("static","img","leafMap1.html"))
```

<iframe src='/img/leafMap1.html', width=800, height=600></iframe>
...
saveWidget(lf, here("static","img","leafMap.html"))
```

<iframe src='/img/leafMap.html', width=800, height=600></iframe>
