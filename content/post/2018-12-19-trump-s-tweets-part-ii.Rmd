...
I start by loading the tmls object that I created [in the previous post](https://www.data.viajes/post/trump-tweet-word-clouds/).  
...
```
That's pretty interesting.  There are considerably more positive days than negative ones.  The timing of the maximum and minimum are fairly clear in time.
...
Now I want to play with the time series properties of the tweet sentiments.  Days of the week and times of day aggregated over different periods can say something...  Perhaps?
