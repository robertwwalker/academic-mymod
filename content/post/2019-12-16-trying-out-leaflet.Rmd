...
Now for some data.  As it happens, the best way I currently know how to do this is going to involve acquiring a spatial frame.  There is one in the package `tmap`.  First, to load it.  My names are upper case.
