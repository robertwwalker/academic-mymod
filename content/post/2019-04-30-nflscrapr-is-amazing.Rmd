...
I decided it was time to experiment with shiny apps again and so I built one out of this.  [Check it out!][https://rwalkerwu.shinyapps.io/NFL-Scrapr/].  There is one thing that I do not like.  The labels are messed up by overtime games.
